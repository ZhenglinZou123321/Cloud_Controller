...
def junction_run(id):
    ...
    id = id
    junc_controller = JunctionController(id,Global_Vars.traffic_light_to_lanes,Global_Vars.N,Global_Vars.dt,Global_Vars.L_safe,redis_base=r)
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        if Global_Vars.step % 20 == 0: #每4s算8s
